...
| — | 5–9 | Nicht begonnen. Reihenfolge gemäß §9: als Nächstes **Phase 5** (Frontend auf v2) — dafür `.env.local` auf den lokalen Stack zeigen lassen und `npm run gen:types` gegen lokal. |

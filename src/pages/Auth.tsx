    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground italic mt-2 font-body">Your private cellar journal</p>
        </div>

        <Card className="p-8 gold-border bg-card/90 shadow-warm backdrop-blur">
          <h2 className="font-display text-2xl mb-6 text-center">
            {mode === "signin" ? "Welcome back" : "Begin your cellar"}
          </h2>
          <form onSubmit={submit} className="space-y-4">
            ...
            <Button type="submit" className="w-full" disabled={loading}>
              ...
              {mode === "signin" ? "Enter the cellar" : "Create cellar"}
            </Button>
          </form>
          <div className="text-center mt-6 text-sm text-muted-foreground">
            {mode === "signin" ? "New here?" : "Already keeping a cellar?"}{" "}
            <button
